			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/all-manufactures')}}"><i class="icon-eye-open"></i><span class="hidden-tablet"> All Manufactures</span></a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{URL::to('/all-sliders')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Sliders</span></a></li>
							</ul>	
						</li>
	...
	<!-- start: JavaScript-->
		...
		<script>
			$(document).on("click", "#delete", function(e){
				e.preventDefault();
				var link = $(this).alter("href");
				bootbox.confirm("Do you really want to execute!", function(confirmed){
					if (confirmed) {
